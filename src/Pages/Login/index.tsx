        ...
        <div className="container-login" >
            ...
            <div className="container-login-right" >
                <div className="box-login">
                    ...
                    <Button className="btn-login"><Link to="/contact" style={{margin:"0 10px", color:"#fff", textDecoration:"none"}} > Login </Link> </Button>
                    <Button className="btn-login" ><Link to="/register" style={{margin:"0 10px", color:"#fff", textDecoration:"none"}}> register </Link></Button>
                </div>
            </div>
        </div>
    );
